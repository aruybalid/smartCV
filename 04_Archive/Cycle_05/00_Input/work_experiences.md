...
MOOSE/BISON model and code development and integration. Merged constitutive model code into BISON framework. 
...
Software development, in particular Python tooling for scientific computing.

LLM-integration in workflows, including using agentic folder structuring.
